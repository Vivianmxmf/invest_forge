...
<meta property="og:image" content="https://raw.githubusercontent.com/Vivianmxmf/janus-terminal/main/docs/screenshots/ui_terminal_decision.png">
...
<meta name="twitter:image" content="https://raw.githubusercontent.com/Vivianmxmf/janus-terminal/main/docs/screenshots/ui_terminal_decision.png">
<!-- Apple touch icon: served from the GitHub raw CDN so iOS home-screen pinning shows the JANUS ⌖ target. -->
<link rel="apple-touch-icon" href="https://raw.githubusercontent.com/Vivianmxmf/janus-terminal/main/assets/janus_apple_touch.png">
<link rel="shortcut icon" type="image/png" href="https://raw.githubusercontent.com/Vivianmxmf/janus-terminal/main/assets/janus_favicon.png">
"""
...
GITHUB_URL = "https://github.com/Vivianmxmf/janus-terminal"
...
RATING_FAVICONS = {
    "BUY":  "https://raw.githubusercontent.com/Vivianmxmf/janus-terminal/main/assets/janus_favicon_buy.png",
    "HOLD": "https://raw.githubusercontent.com/Vivianmxmf/janus-terminal/main/assets/janus_favicon_hold.png",
    "SELL": "https://raw.githubusercontent.com/Vivianmxmf/janus-terminal/main/assets/janus_favicon_sell.png",
}
...
def _pdf_report(state: dict, ts_code: str) -> bytes:
    ...
    c.drawRightString(width - 40, 30,
                      "github.com/Vivianmxmf/janus-terminal  ·  v0.4.1")
